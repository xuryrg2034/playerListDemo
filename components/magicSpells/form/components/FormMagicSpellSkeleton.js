...
const FormMagicSpellSkeleton = (props) => (
    <div className={`popupWrapper formMagicSkeleton`}>
                ...
                <div className={`magicSpellPopup__form`}>
                    <div className={`magicSpellPopup__header`}>
                        <div className={`magicSpellPopup__header_left`}>
                            <div className={`formMagicSkeleton__icon`} />
                        </div>
...
export default FormMagicSpellSkeleton;